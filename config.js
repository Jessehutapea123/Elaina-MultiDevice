...
/*============== PAYMENT ==============*/
global.pdana = '085261896393' //Nomor Danamu
global.ppulsa = '085261896393' //Nomor SimCard Yang Kamu Pake
global.psaweria = '-' //Link Saweriamu Kalo Nggada Ketik - aja

/*============== NOMOR ==============*/
global.nomorbot = '6285261896393' //Nomor Bot
global.nomorown = '6285261896393' //Nomor Owner
global.namebot = 'Wibu BOT' //Nama Bot
global.nameown = '𝓧𝓲𝓪𝓸 - 𝓨𝓪𝓷' // Nama Owner


/*============== STAFF ==============*/
global.owner = [
  ['6285261896393', '❦ J e s s e - 𝚈𝚊𝚗? 🎐', true] //Ganti jd nomormu sama Namamu
...
/*============== WATERMARK ==============*/
global.wm = '                「 Jesse 𝙱𝙾𝚃 汉  」' //Main Watermark
global.wm2 = '꒷︶꒷꒥꒷ ‧₊˚ ꒰ฅ˘Jesse - ᴄʜᴀɴ˘ฅ ꒱ ‧₊˚꒷︶꒷꒥꒷'
global.wm3 = '⫹⫺ Jesse 𝙱𝙾𝚃'
